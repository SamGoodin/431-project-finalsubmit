                            ...
                            <div>
                               ...
                               <asp:GridView
                                   ...
                                   DataKeyNames="ProgramID" 
                                    OnRowCommand="GvSelectedProgram_RowCommand" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField  HeaderText="View Details">
                                            <ItemTemplate>
                                                <asp:Button ID="btnViewProgram" runat="server" class="button special" CommandName="View" CommandArgument='<%# Eval("ProgramID") %>' ToolTip="View" Text="View" />
                                            </ItemTemplate>
                                         </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
