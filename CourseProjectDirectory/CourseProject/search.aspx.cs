...
namespace CourseProject
{
    public partial class search : System.Web.UI.Page
    {
        ...
        protected void GvSelectedProgram_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName.Equals("View"))
            {
                ...
                // Get ProgramID and direct to program details page
                string commandArgs = e.CommandArgument.ToString();

                Session["programselected"] = commandArgs;


                Response.Redirect("program-details.aspx");
